    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(help_text='please format should be +233', max_length=15, unique=True)),
                ('company_name', models.CharField(max_length=200)),
                ('full_name', models.CharField(default='Abag User', max_length=150)),
                ('region', models.CharField(choices=[('Ashanti', 'Ashanti'), ('Greater Accra', 'Greater Accra'), ('Brong-Ahafo', 'Brong-Ahafo'), ('Northern', 'Northern'), ('Central', 'Central'), ('Upper East', 'Upper East'), ('Upper West', 'Upper West'), ('Eastern', 'Eastern'), ('Volta', 'Volta'), ('Western', 'Western')], max_length=50)),
                ('regional_code', models.CharField(blank=True, max_length=20)),
                ('agent_display_code', models.CharField(blank=True, max_length=200)),
