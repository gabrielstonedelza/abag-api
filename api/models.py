...
class AgentsAccountsStartedWith(models.Model):
    agent = models.ForeignKey(User, on_delete=models.CASCADE)
    mtn_physical = models.CharField(max_length=200)
    mtn_eCash = models.CharField(max_length=200)
    vodafone_physical = models.CharField(max_length=200)
    vodafone_eCash = models.CharField(max_length=200)
    airtel_tigo_physical = models.CharField(max_length=200)
    airtel_tigo_eCash = models.CharField(max_length=200)
    ecobank_physical = models.CharField(max_length=200)
    ecobank_eCash = models.CharField(max_length=200)
    calbank_physical = models.CharField(max_length=200)
    calbank_eCash = models.CharField(max_length=200)
    fidelity_physical = models.CharField(max_length=200)
    fidelity_eCash = models.CharField(max_length=200)
